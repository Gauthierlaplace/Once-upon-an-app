        ...
        <div className="HomeBook-double-page">
          ...
          <div className="HomeBook-GlassLeft">
            <div className="HomeBook-left">
              ...
              <div className="HomeBook-menu"><h3 onClick={displayDescriptionFunction}>Accueil</h3><div className="HomeBook-menu-dot-leader" /><span>P.0</span></div>
              <div className="HomeBook-menu"><h3 onClick={displayRegisterFunction}>Inscription</h3><div className="HomeBook-menu-dot-leader" /><span>P.1</span></div>
              <div className="HomeBook-menu"><h3 onClick={displayLoginFunction}>Connexion</h3><div className="HomeBook-menu-dot-leader" /><span>P.2</span></div>
              <NavLink to="/About"><div className="HomeBook-menu"><h3>About</h3><div className="HomeBook-menu-dot-leader" /><span>P.3</span></div></NavLink>
              <div className="HomeBook-menu"><h3>Copyright</h3><div className="HomeBook-menu-dot-leader" /><span>P.4</span></div>
              <div className="HomeBook-menu"><h3>Mentions légales</h3><div className="HomeBook-menu-dot-leader" /><span>P.5</span></div>
            </div>
          </div>
