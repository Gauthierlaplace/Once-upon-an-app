...
function BattleMode() {
  ...
  const ennemyMaxHealth = useSelector((state) => state.game.currentNPC.npcMaxHealth);
  ...
  return (
    <div className="BattleMode">
      ...
      <div className="BattleMode-wrapper">
        <div className="BattleMode-logs">
          { hit != null && (
            <div className="BattleMode-results">
              ...
              { hit === true && (
                <div>
                  <p>Le coup touche !</p>
                  <p>2D4 de dégats : { damageDice1 } et { damageDice2 }</p>
          ...
          <div className="BattleMode-summary">
            ...
            { heroHealth <= 40 && ennemyHealth === 0 && (
              <div>
                <div className="BattleMode-results">Vous ne vous sentez pas très bien, espérons que vous trouverez un endroit pour vous reposer! </div>
              </div>
            )}

            { visibleStartButton && heroHealth > 0 && (
              <div>
                {/* <button
                  type="button"
        ...
        <div className="BattleMode-NPC">
          <div className="BattleMode-NPC-GameNPC">
            <img className="BattleMode-NPC-GameNPC-img" src={enemyPicture} alt={enemyName} />
            <h2 className="BattleMode-NPC-GameNPC-title">{enemyName}</h2>
            <GameHealthBar
              health={ennemyHealth}
              maxHealth={ennemyMaxHealth}
            />
          </div>
        </div>
      </div>
